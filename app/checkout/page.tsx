...
const checkoutSchema = z.object({
  ...
  cardExpiry: z.string().regex(/^\d{2}\/\d{2}$/, 'Expiry date should be in MM/YY format'),
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            ...
                            <br />
                            {form.watch('address1')}
                            {form.watch('address2') && <><br />{form.watch('address2')}</>}
                            <br />
                            {form.watch('city')}, {form.watch('state')} {form.watch('postalCode')}
                            <br />
                            {form.watch('country') === 'US' ? 'United States' : form.watch('country')}
                            <br />
                            {form.watch('phone')}
                          </p>
                        </div>
